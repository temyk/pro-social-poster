...
<p>
    ...
    <a class="btn btn-danger" href="<?php echo $plugin::URL_VK_DEVCREATE; ?>" target="_blank"> ШАГ №1 - Создать
        приложение VK</a>
</p>
<p>
    После прохождения Шага 1 и сохранения настроек плагина, нажмите на ссылку "Шаг2". В результате вы поличите токен,
    который так же вставте в поле настроек плагина и нажмите "Сохранить"
    <a href="https://oauth.vk.com/authorize?client_id=<?php echo $plugin->getOptions( 'vkposter_idsoft' ); ?>&scope=wall,photos,offline&redirect_uri=https://oauth.vk.com/blank.html&display=page&response_type=token"
       target="_blank"> ШАГ №2 - Получить токен</a>
...
<form method="post" action="options.php">
    ...
    <table class="form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" pattern="[0-9]*" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_idsoft]"
                       value="<?php echo $plugin->getOptions( 'vkposter_idsoft' ); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                <input size="90" type="text" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_token]"
                       value="<?php echo $plugin->getOptions( 'vkposter_token' ); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_id]"
                       value="<?php echo $plugin->getOptions( 'vkposter_id' ); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_userid]"
                       value="<?php echo $plugin->getOptions( 'vkposter_userid' ); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <select name="<?php echo $plugin::PREF_PLG; ?>[vkposter_friends_only]">
                    <option value="0" <?php selected( $plugin->getOptions( 'vkposter_friends_only' ), '0', true ); ?>>
                        Всем пользователям
                    </option>
                    <option value="1" <?php selected( $plugin->getOptions( 'vkposter_friends_only' ), '1', true ); ?>>
                        Только участникам
                    </option>
                </select>
        ...
        <tr valign="top">
            ...
            <td>
                <select name="<?php echo $plugin::PREF_PLG; ?>[vkposter_from_group]">
                    <option value="0" <?php selected( $plugin->getOptions( 'vkposter_from_group' ), '0', true ); ?>>От
                        имени пользователя
                    </option>
                    <option value="1" <?php selected( $plugin->getOptions( 'vkposter_from_group' ), '1', true ); ?>>От
                        имени группы
                    </option>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <select name="<?php echo $plugin::PREF_PLG; ?>[vkposter_signed]">
                    <option value="0" <?php selected( $plugin->getOptions( 'vkposter_signed' ), '0', true ); ?>>Подпись
                        добавлена не будет
                    </option>
                    <option value="1" <?php selected( $plugin->getOptions( 'vkposter_signed' ), '1', true ); ?>>Будет
                        добавлена подпись
                    </option>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" pattern="[0-9]*" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_counttext]"
                       value="<?php
        ...
        <tr valign="top">
            ...
            <td>
                ...
                <select name="<?php echo $plugin::PREF_PLG; ?>[text_source]">
                    <option value="post_content" <?php selected( $plugin->getOptions( 'text_source' ), 'post_content', true ); ?>>
                        Главный текст
                    </option>
                    <option value="post_excerpt" <?php selected( $plugin->getOptions( 'text_source' ), 'post_excerpt', true ); ?>>
                        Отрывок поста
                    </option>
                </select>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="checkbox"
                       name="<?php echo $plugin::PREF_PLG; ?>[vkposter_onoff]" <?php checked( $plugin->getOptions( 'vkposter_onoff' ), 'on', 1 ); ?>/>
        ...
        <tr valign="top">
            ...
            <td>
				...
				foreach ( $array_posts as $v ) {
                    ...
                    <p><input name="<?php echo $plugin::PREF_PLG; ?>[vkposter_posttype][<?php echo $v; ?>]"
                              type="checkbox" value="<?php echo $v; ?>" <?php
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_proxy]"
                       value="<?php echo $plugin->getOptions( 'vkposter_proxy' ); ?>"/>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="<?php echo $plugin::PREF_PLG; ?>[vkposter_proxy_userpaswd]"
                       value="<?php echo $plugin->getOptions( 'vkposter_proxy_userpaswd' ); ?>"/>
